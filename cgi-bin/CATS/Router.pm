...
my $main_routes = {
    ...
    problem_history_edit => [ \&CATS::UI::ProblemHistory::problem_history_edit_frame,
        ...
        save => bool, src_enc => encoding, message => str, src => undef, is_amend => bool,
        source => upload, upload => bool, new_name => str, create => bool, dir => str,
    ],
    ...
    problem_history_tree => [ \&CATS::UI::ProblemHistory::problem_history_tree_frame,
        pid => required integer, hb => required sha, file => str, repo_enc => encoding, file_name => str,
    ],
